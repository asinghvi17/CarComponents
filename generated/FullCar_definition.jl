...
@doc Markdown.doc"""
   FullCar(; name, wheel_elastic_contact, chassis_bushings, wheel_base, axle_spacing, wheel_radius, ms, rod_radius)
...
"""
@component function FullCar(; name = nothing, wheel_elastic_contact=false, chassis_bushings=false, wheel_base=Float64(1), axle_spacing=Float64(2.0), wheel_radius=0.2, ms=Float64(1500), rod_radius=0.02, kwargs...)
