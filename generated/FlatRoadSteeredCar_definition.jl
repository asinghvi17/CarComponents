...
@doc Markdown.doc"""
   FlatRoadSteeredCar(; name, wheel_elastic_contact, chassis_bushings, wheel_base, axle_spacing, wheel_radius, ms, rod_radius, steer_angle_fr_cmd, steer_angle_fl_cmd)
...
| `steer_angle_fr_cmd`         | Front-right steering command [rad]                         | rad  |   0.2 |
| `steer_angle_fl_cmd`         | Front-left steering command [rad]                         | rad  |   0.2 |
...
"""
@component function FlatRoadSteeredCar(; name = nothing, wheel_elastic_contact=false, chassis_bushings=false, wheel_base=Float64(1), axle_spacing=Float64(2.0), wheel_radius=0.2, ms=Float64(1500), rod_radius=0.02, steer_angle_fr_cmd=0.2, steer_angle_fl_cmd=0.2, kwargs...)
  isnothing(name) && throw(ArgumentError("""
    The `name` keyword must be provided. Please consider using the `@named` macro,
    like so:
  
    @named model = FlatRoadSteeredCar()
  """))
  ...
  __local__steer_angle_fr_cmd = steer_angle_fr_cmd
  append!(__params, @parameters (steer_angle_fr_cmd::Real), [description = "Front-right steering command [rad]"])
  __initial_conditions[steer_angle_fr_cmd] = __local__steer_angle_fr_cmd
  __local__steer_angle_fl_cmd = steer_angle_fl_cmd
  append!(__params, @parameters (steer_angle_fl_cmd::Real), [description = "Front-left steering command [rad]"])
  __initial_conditions[steer_angle_fl_cmd] = __local__steer_angle_fl_cmd
  ...
  push!(__eqs, steer_angle_fr ~ steer_angle_fr_cmd)
  push!(__eqs, steer_angle_fl ~ steer_angle_fl_cmd)
